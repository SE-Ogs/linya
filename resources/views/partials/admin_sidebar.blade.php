<aside class="bg-[#23222E] w-64 h-screen text-white flex flex-col p-4 font-lexend">
    <div class="flex justify-center mb-8 mt-2">
        <img src="/images/linyaText.svg" alt="LINYA Logo" class="h-10 w-auto" />
    </div>
    <nav class="flex flex-col gap-2">
        <a href="#" class="py-2 px-3 rounded hover:bg-[#35344a] transition text-lg font-bold">Dashboard</a>
        <a href="#" class="py-2 px-3 rounded hover:bg-[#35344a] transition text-base font-medium">User Management</a>
        <div class="bg-orange-400 text-white rounded">
            <button class="w-full flex items-center justify-between py-2 px-3 text-base font-semibold">
                Post Management
