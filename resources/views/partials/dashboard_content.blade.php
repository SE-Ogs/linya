<body class="bg-gray-50 font-inter">
    <div class="p-8 max-w-7xl mx-auto">
        <div id="content" class="bg-white flex flex-col lg:flex-row gap-20">
            ...
            <!-- Right Side -->
            <div id="right_side" class="w-full lg:w-110">
                <!-- Breaking News -->
        ...
        <div class="mt-12">
            ...
            <div class="border-t-4 border-orange-500 w-180 mb-10"></div>

            <!-- Heading -->
            <h2 class="text-2xl font-bold text-gray-800 mb-6">Blogs</h2>

            <!-- Carousel container -->
            <div class="overflow-x-auto flex flex-nowrap space-x-4 custom-scrollbar p-7">

                <!-- Card 1 -->
                <div class="flex-shrink-0 bg-gray-200 rounded p-6">
                    <h3 class="text-lg font-bold mb-2">Short Title</h3>
                    <p class="text-sm text-gray-600">A small description.</p>
                </div>

                <!-- Card 2 -->
                <div class="flex-shrink-0 bg-gray-300 rounded p-6">
                    <h3 class="text-lg font-bold mb-2">A Much Longer News Title That Needs More Space</h3>
                    <p class="text-sm text-gray-600">More text content. Possibly multiple lines.</p>
                </div>

                <!-- Card 3 -->
                <div class="flex-shrink-0 bg-gray-400 rounded p-6">
                    <h3 class="text-lg font-bold mb-2">Medium Title</h3>
                    <p class="text-sm text-gray-600">Another one.</p>
                </div>
                <div class="flex-shrink-0 bg-gray-300 rounded p-6">
                    <h3 class="text-lg font-bold mb-2">A Much Longer News Title That Needs More Space</h3>
                    <p class="text-sm text-gray-600">More text content. Possibly multiple lines.</p>
