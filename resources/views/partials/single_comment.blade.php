...
<div class="comment-item border-l-2 border-gray-200 pl-4 mb-4" id="comment-{{ $comment->id }}">
    <div class="flex items-start mb-2">
        ...
        <div>
            ...
            <div class="flex items-center mt-2 text-sm">
                {{-- Like Button --}}
                <button class="flex items-center mr-4 text-gray-600 hover:text-blue-600 like-btn {{ $userReaction && $userReaction->type === 'like' ? 'text-blue-600' : '' }}"
                ...
                {{-- Dislike Button --}}
                <button class="flex items-center mr-4 text-gray-600 hover:text-red-600 dislike-btn {{ $userReaction && $userReaction->type === 'dislike' ? 'text-red-600' : '' }}"
    ...
    <div class="replies ml-8 mt-4">
        @foreach($comment->replies as $reply)
            ...
            @include('partials.single_comment', ['comment' => $reply, 'articleId' => $articleId])
        @endforeach
    </div>
</div>